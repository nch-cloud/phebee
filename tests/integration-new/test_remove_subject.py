...
def test_remove_subject_not_last_mapping(
    ...
    wait_for_subject_terms(subject_id=subject_uuid, termlink_id=termlink_id, project_id=project_a_id)
    wait_for_subject_terms(subject_id=subject_uuid, termlink_id=termlink_id, project_id=project_b_id)
