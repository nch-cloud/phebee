...
def test_reset_database_clears_iceberg_tables(cloudformation_stack, test_project_id, query_athena, standard_hpo_terms, wait_for_subject_terms):
    ...
    # Wait for subject_terms tables to be updated
    wait_for_subject_terms(subject_id, termlink_id, test_project_id)
