...
def test_r11_enhanced_api_latency_at_scale(
    ...
    env_vars = {
        ...
        "PHEBEE_EVAL_SCALE_MIN_TERMS": os.environ.get("PHEBEE_EVAL_SCALE_MIN_TERMS", "150 (default, production p75)"),
        "PHEBEE_EVAL_SCALE_MAX_TERMS": os.environ.get("PHEBEE_EVAL_SCALE_MAX_TERMS", "500 (default, production p90)"),
        "PHEBEE_EVAL_SCALE_MIN_EVIDENCE": os.environ.get("PHEBEE_EVAL_SCALE_MIN_EVIDENCE", "1 (default, production min)"),
